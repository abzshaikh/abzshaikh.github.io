$(document).ready(function(){
    ...
    $(".back-drop").css({"background":"linear-gradient(to right,#000000,#929292),url(http://image.tmdb.org/t/p/original/"+finalvalue.backdrop_path,"background-repeat":"no-repeat","background-size":"cover","background-blend-mode":"hard-light"});
    $(".overview-content").html(finalvalue.overview);
    $("#overview-img").attr("src","http://image.tmdb.org/t/p/original/"+finalvalue.poster_path);
