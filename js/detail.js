$(document).ready(function(){
    ...
    $(".main-detail-banner").css({"background":"url(http://image.tmdb.org/t/p/w185/"+finalvalue.backdrop_path,"background-repeat":"no-repeat","background-size":"cover","background-blend-mode":"hard-light"});
